...
void SSD1306_DrawBitmap(uint16_t x, uint16_t y, const unsigned char* bitmap, int16_t w, int16_t h, SSD1306_COLOR_t color)
{
...
void ssd1306_I2C_WriteMulti(uint8_t address, uint8_t reg, uint8_t* data, uint16_t count) {
	...
	if (HAL_I2C_Master_Transmit(&hi2c1, address, dt, count+1, 25) != HAL_OK) 
...
void ssd1306_I2C_Write(uint8_t address, uint8_t reg, uint8_t data) {
	...
	if (HAL_I2C_Master_Transmit(&hi2c1, address, dt, 2, 25) != HAL_OK) 
		I2C1->CR1 |= I2C_CR1_SWRST;
}
